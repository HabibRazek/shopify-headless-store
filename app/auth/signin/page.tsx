    ...
    try {
      ...
      if (result?.error) {
        ...
        if (result.error === "Email does not exist") {
          ...
          errorMessage = "Mot de passe incorrect ou compte inexistant";
        }
          ...
          <form onSubmit={handleSubmit(onSubmit)} className="space-y-5">
            ...
            <div className="space-y-1">
              <div className="flex items-center justify-between">
                ...
                <Link href="/auth/forgot-password" className="text-xs text-green-600 hover:text-green-500 hover:underline">
                  Forgot password?
                </Link>
              </div>
              <div className="relative">
