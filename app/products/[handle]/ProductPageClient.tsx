...
export default function ProductPageClient({ product, handle }: ProductPageClientProps) {
      ...
      <div className="mx-auto max-w-2xl px-4 py-8 sm:px-6 lg:max-w-7xl lg:px-8">
        ...
        <div className="lg:grid lg:grid-cols-2 lg:items-start lg:gap-x-12">
          ...
          <div className="mt-10 px-4 sm:mt-16 sm:px-0 lg:mt-0">
            ...
            <div className="mb-6">
              <div className="py-4">
                <p className="text-3xl sm:text-4xl font-bold text-gray-900 mb-2" itemProp="price">
                ...
                <div className="grid grid-cols-2 sm:grid-cols-3 gap-3">
                  {variants.map((variant) => (
                    <button
                      ...
                      aria-label={`Sélectionner la variante ${variant.node.title}`}
                    >
                      {selectedVariant === variant.node.id && (
              ...
              <div className="bg-white p-4 rounded-2xl border border-gray-200 shadow-sm">
                <div className="flex items-center justify-center max-w-xs mx-auto">
                  ...
                  <div className="w-20 h-12 border-t-2 border-b-2 border-green-300 bg-green-50 flex items-center justify-center">
                    <span className="text-2xl font-bold text-green-800" aria-label={`Quantité: ${quantity}`}>
                      {quantity}
                    </span>
                  </div>
            ...
            <div className="mb-8 flex flex-col sm:flex-row gap-4">
              <button
                ...
                aria-label={`Ajouter ${quantity} ${product.title} au panier`}
              >
              ...
              <button
                ...
                aria-label={`Acheter ${quantity} ${product.title} maintenant`}
              >
        ...
        {/* SEO-optimized Product Description and Details */}
        <div className="mt-16 lg:grid lg:grid-cols-3 lg:gap-x-12">
          ...
          <div className="lg:col-span-2">
            ...
            <div className="mb-8">
              ...
              <div className="bg-white p-6 rounded-2xl border border-gray-200 shadow-sm" itemProp="description">
                <div
            ...
            <div className="border-t border-gray-200 pt-8">
              ...
              <div className="space-y-4">
                ...
                {/* SEO-friendly product features */}
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mt-6">
                  <div className="bg-green-50 p-4 rounded-lg">
                    <h4 className="font-semibold text-green-800 mb-2">✓ Qualité Premium</h4>
                    <p className="text-sm text-green-700">Matériaux de haute qualité certifiés</p>
                  </div>
                  <div className="bg-green-50 p-4 rounded-lg">
                    <h4 className="font-semibold text-green-800 mb-2">✓ Personnalisation</h4>
                    <p className="text-sm text-green-700">Impression et design sur mesure</p>
                  </div>
                  <div className="bg-green-50 p-4 rounded-lg">
                    <h4 className="font-semibold text-green-800 mb-2">✓ Livraison Rapide</h4>
                    <p className="text-sm text-green-700">24-48h en Tunisie</p>
                  </div>
                  <div className="bg-green-50 p-4 rounded-lg">
                    <h4 className="font-semibold text-green-800 mb-2">✓ Support Expert</h4>
                    <p className="text-sm text-green-700">Conseil professionnel inclus</p>
                  </div>
                </div>
              </div>
            </div>
